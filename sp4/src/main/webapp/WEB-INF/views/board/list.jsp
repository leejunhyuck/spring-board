...
<%@include file="../includes/header.jsp" %>
 ...
 $(".page-link").on("click",function(e){
	...
	console.log("targetPage"+gi);
	

	actionForm.find("input[name='page']").val(gi);
	actionForm.find("input[name='page']").val(document.querySelector("#amount"));
	actionForm.submit();
 ...
 $('.opt').on("change",function(e){
	 ...
	 actionForm.find("input[name='page']").val(1);
		actionForm.submit();
		 ...
		 actionForm.find("input[name='page']").val(amountValue);
			actionForm.submit();
